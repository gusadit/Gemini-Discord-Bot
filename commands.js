/**
 * @file commands.js
 * @description This file contains the command definitions for the bot.
 */
const commands = [
    {
        name: "respond_to_all",
        description:
            "Ensures the bot always responds to all messages in this channel.",
        options: [
            {
                name: "enabled",
        ...
        options: [
            {
                name: "enabled",
                description:
                    "Set to true to enable chat wide history, or false to disable it.",
                type: 5,
                required: true,
            },
            {
